...
public class RedmineJournalsReader {
    ...
    public static void main(String args[]) {
        RedmineJournalsReader test = new RedmineJournalsReader("http://www.hostedredmine.com", "f4b2a2953034f344cb45c08359ee76577dc20977");
        ArrayList<String> journals = test.getJournals("730968");
